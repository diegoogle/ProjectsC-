...
public partial class _Default : System.Web.UI.Page, ICallbackEventHandler
{
  ...
  protected void Page_Load(object sender, EventArgs e)
  {
    if (!IsCallback)
    {
      ...
      string popupScript =
        ...
        "</script>";
      if (!Page.ClientScript.IsStartupScriptRegistered("PopupScript"))
        Page.ClientScript.RegisterStartupScript(typeof(_Default),
                   "PopupScript", popupScript); // antes de </form>
      //Page.ClientScript.RegisterClientScriptBlock(typeof(_Default),
      //           "PopupScript", popupScript); // después de <form>
    }
  }
  ...
  private string DevuelveXML(string[] ElementosMatriz)
  {
    ...
    miEscritorTexto = new System.IO.StreamWriter(@"C:\Inetpub\wwwroot\AJAX3\App_Data\respuesta.txt");
    ...
    string respuestaXML = System.IO.File.ReadAllText(@"C:\Inetpub\wwwroot\AJAX3\App_Data\respuesta.txt");
