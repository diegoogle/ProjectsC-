...
<body>
  <form id="form1" runat="server">
    <div>
      ...
      <asp:DropDownList ID="lsdAsignatura" runat="server" Style="z-index: 102; left: 210px; position: absolute; top: 104px"
        Width="320px">
      </asp:DropDownList>
      ...
      <asp:RequiredFieldValidator ID="cvDni" runat="server" ControlToValidate="ctDni" ErrorMessage="DNI requerido"
        Style="z-index: 107; left: 520px; position: absolute; top: 71px; right: 353px;" ForeColor="Red">*</asp:RequiredFieldValidator>
      <asp:RangeValidator ID="cvDniRango" runat="server" ControlToValidate="ctDni" ErrorMessage="Valor fuera de rango"
        MaximumValue="99999999" MinimumValue="999999" Style="z-index: 108; left: 530px; position: absolute; top: 71px"
        Type="Integer" ForeColor="Red">*</asp:RangeValidator>
      <asp:ValidationSummary ID="cvMensajes" runat="server" Style="z-index: 109; left: 550px; position: absolute; top: 66px; width: 194px;" ForeColor="Red" />
    </div>
  </form>
</body>
</html>
