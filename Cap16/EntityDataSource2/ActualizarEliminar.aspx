...
<body>
  <form id="form1" runat="server">
    <div>
      ...
      <br />
      <asp:ListView ID="ListView1" runat="server" DataKeyNames="id_alumno,id_asignatura" DataSourceID="EntityDataSource1">
      ...
      <br />
      <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="Default.aspx">Volver</asp:HyperLink><br /><br />
      <asp:ListView ID="ListView2" runat="server" DataKeyNames="id_alumno" DataSourceID="EntityDataSource2">
        <AlternatingItemTemplate>
          <tr style="background-color:#FFF8DC;">
            <td>
              <asp:Button ID="DeleteButton" runat="server" CommandName="Delete" Text="Eliminar" />
    ...
    <br />
    <asp:HyperLink ID="HyperLink3" runat="server" NavigateUrl="Default.aspx">Volver</asp:HyperLink><br /><br />
      <asp:ListView ID="ListView3" runat="server" DataKeyNames="id_asignatura" DataSourceID="EntityDataSource3">
        <AlternatingItemTemplate>
          <tr style="background-color:#FFF8DC;">
            <td>
              <asp:Button ID="DeleteButton" runat="server" CommandName="Delete" Text="Eliminar" />
    ...
    <br />
    <asp:HyperLink ID="HyperLink4" runat="server" NavigateUrl="Default.aspx">Volver</asp:HyperLink><br /><br />
    </div>
  </form>
</body>
</html>
